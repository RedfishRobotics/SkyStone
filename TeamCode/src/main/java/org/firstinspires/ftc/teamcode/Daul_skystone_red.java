...
//            encoderStrafeLeft(0.5, 6, 6, 5);
            if (valLeft == 0) {
                ...
                rightRearDrive.setMode(DcMotor.RunMode.RUN_USING_ENCODER);
                sleep(500);
                encoderDriveForwardStraight(0.5, 12, 20,true, 0, false);
                rightSkystoneServo.setPosition(0.17);
                sleep(500);
                leftFrontDrive.setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.FLOAT);
                leftRearDrive.setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.FLOAT);
                ...
                rightFrontDrive.setMode(DcMotor.RunMode.RUN_USING_ENCODER);
                rightRearDrive.setMode(DcMotor.RunMode.RUN_USING_ENCODER);
                encoderDriveBackwardStraight(0.75, -50, 36, true, 0, false);
                rightSkystoneServo.setPosition(0.6);
                leftFrontDrive.setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.BRAKE);
                leftRearDrive.setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.BRAKE);
                rightFrontDrive.setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.BRAKE);
                ...
                rightRearDrive.setMode(DcMotor.RunMode.RUN_USING_ENCODER);
                sleep(500);
                encoderDriveForwardStraight(0.5, 7, 20,true, 0, false);
                rightSkystoneServo.setPosition(0.17);
                sleep(500);
                leftFrontDrive.setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.FLOAT);
                leftRearDrive.setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.FLOAT);
