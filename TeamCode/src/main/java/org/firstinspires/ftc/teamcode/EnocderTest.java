 ...
 *YES
 */
@Autonomous(name= "EncoderTest", group="Sky autonomous")
...
//            leftIntake.setPower(0.55);
            encoderDriveForwardStraight(0.5, 16, 20, true, 0, false);
            sleep(500);
//            if (gamepad2.dpad_down || beamBreak.getState() == false) {
//                stoneGripServo.setPosition(0.63);
//                sleep(500);
//                encoderDriveBackwardStraight(0.5,-16,20, true, 0, false);
//                stop();
//            }
//            encoderDriveBackwardStraight(0.5,16,20, true, 0, false);
//            sleep(500);
            ...
            elevatorMotor.setMode(DcMotor.RunMode.RUN_TO_POSITION);
            elevatorMotor.setPower(0.75);
//            gyroTurn(0.65, -179, 0.025);
//            sleep(1000);
//            encoderDriveForwardStraight(0.5,30, 20, true, -179,  false);
            stop();
//            gyroTurn(0.35, 90, 0.025);
//            encoderDrive(0.5, 24, 24, 5);
//            encoderDriveStraight(0.5, 24, 5, true, 0, false);
//            sleep(5000);
//            encoderDriveStraight(0.5, 24,5, true, 0, false);
//            encoderDrive(0.5, -24, -24, 5);
//            sleep(5000);
...
//                rightSkystoneServo.setPosition(0.2);
//                sleep(1000);
//                leftFrontDrive.setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.FLOAT);
//                leftRearDrive.setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.FLOAT);
//                rightFrontDrive.setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.FLOAT);
